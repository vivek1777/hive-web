...
public class Filtered_Request_Response extends HttpsAwareFiltersAdapter {
//    public Filtered_Request_Response(HttpRequest originalRequest, ChannelHandlerContext ctx) {
...
//	}
     ...
     */
    public Filtered_Request_Response(HttpRequest originalRequest, ChannelHandlerContext ctx, Har har, String currentPageRef, Set<CaptureType> dataToCapture) {
        super(originalRequest, ctx);
